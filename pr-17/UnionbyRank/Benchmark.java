...
public class Benchmark {
        ...
        public void N(int size) {
            UnionRank input = new UnionRank(size);
            ...
            System.out.println("Waktu rata-rata untuk find (Union by Rank): " + totalFind / 100 + " ns");
            System.out.println("Waktu rata-rata untuk union (Union by Rank): " + totalUnion / 100 + " ns");
        }
