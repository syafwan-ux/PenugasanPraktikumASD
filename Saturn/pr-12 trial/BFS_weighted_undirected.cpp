...
void breadthFirstSearch() {
    ...
    while (!isQueueEmpty()) {
        ...
        while ((unvisitedVertex = getAdjacencyUnvisited(tempVertex)) != -1) {
            ...
            cout << ",(" << lstVertices[unvisitedVertex]->label << "," << adjMatrix[tempVertex][unvisitedVertex] << ")";
...
int main() {
    ...
    // Add undirected weighted edges (random weights)
    ...
    cout << "Breadth First Search on Weighted Undirected Graph: ";
    breadthFirstSearch();
    return 0;
}
